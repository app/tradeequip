/****************************************************************************
** $Id: teconnectserial.cpp,v 1.1 2006/07/12 09:12:32 leader Exp $
**
...
*/
#ifndef TECONNECTSERIAL_CPP
#define TECONNECTSERIAL_CPP
#include "teconnectserial.h"
#include <tserialport.h>
#include <stdarg.h>

/*!
    \class TEConnectSerial teconnectserial.h
    \brief The TEConnectSerial is base class to connect with trade equipment.
 ...
 * \return - command execution result.
 */
TEConnectSerial::TEConnectSerial( int pn ) : TEConnect( pn )
{
}

/*!
*/
TEConnectSerial::~TEConnectSerial()
{
}
