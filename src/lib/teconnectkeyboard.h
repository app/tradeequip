/****************************************************************************
** $Id: teconnectkeyboard.h,v 1.1 2006/07/12 09:34:21 leader Exp $
**
...
*/
#ifndef TECONNECTKEYBOARD_H
#define TECONNECTKEYBOARD_H
...
//---------------------------------------------------------------------------
class LIB_EXPORT TEConnectKeyboard : public TEConnect
{
    Q_OBJECT

public:

    TEConnectKeyboard( int pn );
    ~TEConnectKeyboard();
};
//---------------------------------------------------------------------------
