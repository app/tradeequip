...
\brief QT system independed serial port class.
...
*/
QextSerialPort::QextSerialPort(PortSettings const& settings):QextBaseType(settings) {}

/*!
\fn QextSerialPort::QextSerialPort(const char* name, PortSettings const& settings)
Constructs a port with the name and settings specified.
*/
QextSerialPort::QextSerialPort(const char* name, PortSettings const& settings)
...
Copy constructor.
*/
QextSerialPort::QextSerialPort(const QextSerialPort& s):QextBaseType(s) {}
